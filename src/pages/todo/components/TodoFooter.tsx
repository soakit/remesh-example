...
import { TodoFilterDomain } from '../../../domains/todo/domains/TodoFilter'
  ...
  return (
    <footer className="footer">
      ...
      <ul className="filters">
        <li>
          <NavLink to="/todo" end className={getClassName}>
            All
          </NavLink>
        </li>
        <li>
          <NavLink to="/todo/active" className={getClassName}>
            Active
          </NavLink>
        </li>
        <li>
          <NavLink to="/todo/completed" className={getClassName}>
            Completed
          </NavLink>
        </li>
      </ul>
